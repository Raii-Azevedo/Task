...
urlpatterns = [
    ...
    path("knowledge/deck/", login_required(views.deck_list), name="deck_list"),
    ...
    path("knowledge/glossary/<int:pk>/", login_required(views.glossary_detail), name="glossary_detail"),
    path("knowledge/glossary/<int:pk>/delete/", login_required(views.delete_glossary_term), name="delete_glossary_term"),
    path("knowledge/case-studies/", login_required(views.case_study_list), name="case_study_list"),
    path("knowledge/case-studies/<int:pk>/", login_required(views.case_study_detail), name="case_study_detail"),
    path("knowledge/case-studies/<int:pk>/delete/", login_required(views.delete_case_study), name="delete_case_study"),
